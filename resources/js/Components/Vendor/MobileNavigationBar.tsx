...
import { LogOut, Logs, Menu, Package, Store, X } from 'lucide-react';
...
export default function MobileNavigationBar() {
    ...
    return (
        <>
            ...
            <div
                className={`fixed bottom-0 top-0 z-30 w-full border bg-white px-3 py-5 transition-all duration-300 ease-in-out md:w-2/3 lg:w-60 dark:border-zinc-800/60 dark:bg-neutral-900 ${toggleState ? '' : 'hidden lg:block'}`}
            >
